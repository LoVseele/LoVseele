...
> GitHub 仓库链接：
> https://github.com/LoVseele/LoVseele/tree/main/3124004443
...
> 「预估」列于动手编码前填写，「实际」列于实现完成后补录。
> 合计预估约 3 小时、实际约 3.3 小时。

| PSP2.1 | 阶段 | 预估（分钟） | 实际（分钟） |
| --- | --- | --- | --- |
| Planning | 计划 |  |  |
| · Estimate | 估计任务量 | 10 | 10 |
| Development | 开发 |  |  |
| · Analysis | 需求分析（含学习新技术） | 25 | 30 |
...
- **耗时**：性能剖析与优化约 **15 分钟**（含编写 `profile_run.py`、`make_chart.py` 与对比实验）。
